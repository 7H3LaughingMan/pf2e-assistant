...
import astUtils from "../node_modules/eslint/lib/rules/utils/ast-utils.js";
    ...
    meta: {
        ...
        schema: {
            ...
            items: {
                ...
                not: {
                    anyOf: [{ required: ["allowObjects", "object"] }, { required: ["allowProperties", "property"] }]
                },
        ...
        messages: {
            restrictedObjectProperty: "'{{objectName}}.{{propertyName}}' is restricted from being used.",
            restrictedProperty: "'{{propertyName}}' is restricted from being used."
        }
    },
